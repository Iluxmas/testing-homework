  ...
  return (
    <div className={bem()}>
      <div className='mb-3'>
        ...
        />
        <div data-testid='nameError' className='invalid-feedback'>
      ...
      <div className='mb-3'>
        ...
        />
        <div data-testid='phoneError' className='invalid-feedback'>
      ...
      <div className='mb-3'>
        ...
        ></textarea>
        <div data-testid='addressError' className='invalid-feedback'>
